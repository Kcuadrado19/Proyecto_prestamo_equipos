...
/*    public static void main(String[] args) {
        // Opciones que se mostrarán en el cuadro de diálogo
        ...
        int seleccion = JOptionPane.showOptionDialog(
            ...
            JOptionPane.YES_NO_CANCEL_OPTION, // Tipo de opción (puede ser cambiado)
            JOptionPane.QUESTION_MESSAGE, // Tipo de mensaje (puede ser cambiado)
